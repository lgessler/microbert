...
@Head.register("bilt_mlm")
class BiltMlmHead(Head):
    ...
    def forward(
        ...
        # n long tuple of tensors of shape (batch_size, num_heads, seq_len, hidden_dim), where n is number of layers
        attentions = attentions.unbind(dim=0)
        # n+1 long tuple of tensors of shape (batch_size, seq_len, hidden_dim) where n is number of layers.
        # Index 0 is the initial embedding layer's outputs, index i is layer i-1's output
